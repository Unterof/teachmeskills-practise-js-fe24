...
let store = {
  _state: {
    dialogsItems: {
      ...
      dialogs: [
        ...
        {
          name: "Valery",
          message: "You need to learn javascript more!",
          id: 4,
        },
    ...
    postsSection: {
      posts: [
        {
          id: 1,
          message: "Hello, I'm trying to understand prop's in react",
          likesCount: 5,
        },
  ...
  dispatch(action) {
    this._state.postsSection = profileReducer(this._state.postsSection, action);
    this._state.dialogsItems = dialogsReducer(this._state.dialogsItems, action);
    this._state.sidebarSection = sidebarReducer(
      this._state.sidebarSection,
      action
    );
